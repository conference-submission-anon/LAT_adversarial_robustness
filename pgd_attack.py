...
class LinfPGDAttack:
	...
	def perturb(self, x_nat, y, sess):
		...
		for i in range(self.num_steps):
			losses = sess.run(self.model.xent, feed_dict={self.model.x_input: x,self.model.y_input: y})
...
if __name__ == '__main__':
	...
	model_file = './models/feature_adv11_secret/checkpoint-1000'
